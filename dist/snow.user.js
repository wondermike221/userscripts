...
var css_248z = ".directory-nav-container{background-color:#f9f9f9;border:1px solid #ccc;border-radius:8px;box-sizing:border-box;display:flex;flex-direction:column;font-family:Arial,sans-serif;min-height:300px;overflow:hidden;padding:10px;position:relative;width:300px}.directory-nav-container:focus{border-color:#1e90ff;outline:2px solid #1e90ff}.directory-header{align-items:center;border-bottom:1px solid #eee;display:flex;flex-shrink:0;margin-bottom:10px;padding-bottom:10px}.back-button{background:none;border:none;color:#333;cursor:pointer;font-size:1.6em;font-weight:700;line-height:1;margin-right:10px;padding:0 8px}.back-button:hover{color:#000}.current-path{color:#333;flex-grow:1;font-size:1.1em;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.options-list-wrapper{flex-grow:1;overflow:hidden;position:relative}.options-view{background-color:#f9f9f9;box-sizing:border-box;height:100%;left:0;padding:5px 0;position:absolute;top:0;width:100%}.options-view ul{list-style:none;margin:0;padding:0}.options-list-item{align-items:center;border-bottom:1px solid #eee;cursor:pointer;display:flex;padding:10px 8px;transition:background-color .2s ease}.options-list-item:last-child{border-bottom:none}.options-list-item:hover{background-color:#e9e9e9}.option-number{color:#555;font-weight:700;margin-right:12px;min-width:20px;text-align:right}.option-name{color:#333;flex-grow:1}.option-type-indicator{color:#777;font-size:.9em;margin-left:8px}.slide-forward-enter-from{transform:translateX(100%)}.slide-forward-enter-to{transform:translateX(0)}.slide-forward-enter-active{transition:transform .3s ease-out}.slide-forward-exit-from{transform:translateX(0)}.slide-forward-exit-to{transform:translateX(-100%)}.slide-forward-exit-active{transition:transform .3s ease-in}.slide-backward-enter-from{transform:translateX(-100%)}.slide-backward-enter-to{transform:translateX(0)}.slide-backward-enter-active{transition:transform .3s ease-out}.slide-backward-exit-from{transform:translateX(0)}.slide-backward-exit-to{transform:translateX(100%)}.slide-backward-exit-active{transition:transform .3s ease-in}.initial-load-enter-active,.initial-load-exit-active{transition:none}";
